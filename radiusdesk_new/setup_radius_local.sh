...
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/tmp
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/logs
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/webroot/img/realms
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/webroot/img/dynamic_details
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/webroot/img/dynamic_photos
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/webroot/img/access_providers
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/webroot/img/hardwares
#chown -R www-data. $RADIUSDESK_VOLUME/web/html/cake3/rd_cake/webroot/files/imagecache  
